...
agent-browser screenshot /absolute/path/home.png
agent-browser close
...
agent-browser screenshot /absolute/path/result.png
```
...
agent-browser state save /absolute/path/auth.json

# Later runs start already-logged-in
agent-browser --state /absolute/path/auth.json open https://app.example.com
```
...
agent-browser snapshot -i --json > /absolute/path/page.json
...
```bash
agent-browser screenshot /absolute/path/page.png                  # save to a specific absolute path
agent-browser screenshot --full /absolute/path/full.png           # full scroll height
agent-browser screenshot --annotate /absolute/path/map.png        # numbered labels + legend keyed to snapshot refs
```
...
# ... perform actions ...
agent-browser network har stop /absolute/path/trace.har
```

### Record a video of the workflow

```bash
agent-browser record start /absolute/path/demo.webm
agent-browser open https://example.com
agent-browser snapshot -i
